...
class Station (models.Model):
    ...
    name_eng = models.CharField(max_length=30, default="")
    address_fin = models.CharField(max_length=40)
    address_swe = models.CharField(max_length=40)
    city_fin = models.CharField(null=True, max_length=30)
    city_swe = models.CharField(null=True, max_length=30)
    operator = models.CharField(null=True, max_length=30)
